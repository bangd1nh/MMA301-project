  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.navbar}>
        ...
        />
        <View style={{ flexDirection: "row", gap: 20 }}>
          <TouchableOpacity onPress={() => setToggleSearch(!toogleSearch)}>
      ...
      <View style={styles.slide}>
        <Swiper showsButtons={true} style={styles.swiper}>
          {shoes.map((book, index) => (
            <View key={index}>
              <Image source={book.image} style={styles.bookslide} />
            </View>
          ))}
        </Swiper>
      </View>
          ...
          {shoes.map((book, index) => (
            <View key={index} style={{ flexDirection: "row" }}>
              <View style={{ flexDirection: "column" }}>
                <Image source={book.image} style={styles.bookslidesmall} />
              ...
              {index + 1 < shoes.length && (
                <View style={{ flexDirection: "column" }}>
                  ...
                  />
                  <Text style={styles.price}>{shoes[index + 1].price}$</Text>
                </View>
              )}
            </View>
          ))}
